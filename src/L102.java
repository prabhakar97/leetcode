...
public class L102 {
    /**
     * 107. Binary Tree Level Order Traversal https://leetcode.com/problems/binary-tree-level-order-traversal/
     *
     * @timeComplexity O(n)
     * @spaceComplexity O(n)
     */
    static class Solution {
        public List<List<Integer>> levelOrderBottom(TreeNode root) {
            ...
            return result.entrySet().stream().sorted(Comparator.comparing(Map.Entry::getKey)).map(Map.Entry::getValue).collect(Collectors.toList());
        }
    }
}
